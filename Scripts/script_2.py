...
def wait_ekf_ready(master):
    print("Waiting for EKF ready...")
    while True:
...
def check_prearm_errors(master, seconds=3):
    print("Checking pre-arm messages...")
...
'''master.mav.command_long_send(
    ...
    0,
    0, 0, 0, 0, 1, 0, 0  # accel calibration
)
print("Accel calibration sent")
time.sleep(2)
